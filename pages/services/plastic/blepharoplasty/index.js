...
Блефаропластика также может частично устранить этнические черты, например, придать черты европеоидной расы азиатам."
      ...
      <div className={css.wrapper}>
        <p className={css.textCard}>
          ...
          клинике работают опытные хирурги, специализирующиеся на
          блефаропластике. Мы используем современные технологии и методики,
          чтобы обеспечить максимально безопасный и эффективный результат. Наши
          ...
          Если вы хотите узнать больше о блефаропластике или записаться на
          ...
          сделать первый шаг к новому взгляду.
        </p>
        <PhotoCard
